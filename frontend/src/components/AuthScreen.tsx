          ...
          >
            <Box
              sx={{
                ...
                height: 80,
                borderRadius: '50%',
                background: 'linear-gradient(45deg, #ff5555, #f2c94c, #27ae60, #2f80ed)',
                display: 'flex',
                justifyContent: 'center',
                alignItems: 'center',
                boxShadow: '0 0 20px rgba(156, 39, 176, 0.5), inset 0 0 15px rgba(255, 255, 255, 0.3)',
            ...
            <Typography variant="h5" align="center" sx={{ fontWeight: 800, letterSpacing: 0.5 }}>
              {isLogin ? 'Welcome Back' : 'Create Account'}
            </Typography>
            <Typography variant="body2" color="text.secondary" align="center" sx={{ mt: 0.5 }}>
              {isLogin ? 'Enter your credentials to play' : 'Join the game lobbies and play with friends'}
            </Typography>
          </Box>
